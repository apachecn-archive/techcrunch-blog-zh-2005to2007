...
![gpdrive.jpg](img/396268294f9bd4a06eefc2c85f91e699.png)当然，前提是您拥有并运营一个拥有 10，000 个驱动器的数据中心。但是，即使你不这样做，GreenPower 系列驱动器也能显著降低所需电量。根据 Western Digital 的数据，一个典型的 1TB 硬盘使用 13.5 瓦，而 GP 硬盘减少了 5 瓦以上，因此几乎减少了一半的功率。
